...
public class TestPhotoLibrary {
    ...
    public void testGetPhotosNormalCase(){
        ...
        testPhotoLibrary.takePhoto(photo1);
        testPhotoLibrary.takePhoto(photo2);
        testPhotoLibrary.takePhoto(photo3);
    ...
    public void testErasePhotoNormalCase(){
        ...
        testPhotoLibrary.erasePhoto(photo1);
        ArrayList<Photograph> expectedPhotos = new ArrayList<Photograph>();
        expectedPhotos.add(photo2);
        expectedPhotos.add(photo3);
    ...
    /** removing a photo that's not in the PhotoLibrary, expect to return false and not to change the PhotoLibrary */
    @Test
    public void testErasePhotoPhotoDoesNotExist(){
        ...
        testPhotoLibrary.takePhoto(photo1);
        testPhotoLibrary.takePhoto(photo2);
        assertFalse(testPhotoLibrary.erasePhoto(photo3));
    ...
    public void testSimilarityNormalCase(){
        ...
        testPhotoLibrary1.takePhoto(photo1);
        testPhotoLibrary1.takePhoto(photo2);
        testPhotoLibrary2.takePhoto(photo2);
        testPhotoLibrary2.takePhoto(photo3);
