...
public class Photograph implements Comparable<Photograph> {
    ...
    public String toString() {
        return "Photograph with filename: \"" + this.getImagefile().getPath() + "\" and caption: " + this.getCaption();
    }

    /**
     * creates a multi-line string in html format to be used with Swing for GUI
     * @return an html string displaying the caption, date-taken, and rating of this photo
     */
    public String createHtmlString(){
        String result = "<html>";
        result+="Caption: "+this.caption+"<br>";
        result+="DateTaken: "+ this.dateTaken +"<br>";
        result+="Rating: "+ String.valueOf(this.rating);
        result+="</html>";
        return result;
    }
